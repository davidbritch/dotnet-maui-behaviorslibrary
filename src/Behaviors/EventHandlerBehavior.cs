...
namespace Behaviors
{
    ...
    public sealed class EventHandlerBehavior : BehaviorPropertiesBase
	{
		...
		public static readonly BindableProperty EventNameProperty = 
			BindableProperty.Create(nameof(EventName), typeof(string), typeof(EventHandlerBehavior), propertyChanged: OnEventNameChanged);
		public static readonly BindableProperty SourceObjectProperty = 
			BindableProperty.Create(nameof(SourceObject), typeof(object), typeof(EventHandlerBehavior), null, propertyChanged: OnSourceObjectChanged);
