...
namespace Behaviors
{
	...
	public sealed class DataChangedBehavior : BehaviorPropertiesBase
	{
		...
		public static readonly BindableProperty ComparisonProperty = 
			BindableProperty.Create("Comparison", typeof(ComparisonCondition), typeof(DataChangedBehavior), ComparisonCondition.Equal, propertyChanged: OnValueChanged);
