...
namespace Behaviors
{
	...
	{
		public static readonly BindableProperty FinalScaleProperty = 
			BindableProperty.Create(nameof(FinalScale), typeof(double), typeof(ScaleAction), 1.0);
		public static readonly BindableProperty IsRelativeProperty = 
			BindableProperty.Create(nameof(IsRelative), typeof(bool), typeof(ScaleAction), false);
