...
namespace Behaviors
{
	...
	{
		public static readonly BindableProperty FinalAngleProperty = 
			BindableProperty.Create(nameof(FinalAngle), typeof(double), typeof(RotateAction), 0.0);
		public static readonly BindableProperty IsRelativeProperty = 
			BindableProperty.Create(nameof(IsRelative), typeof(bool), typeof(RotateAction), false);
		public static readonly BindableProperty AxisProperty = 
			BindableProperty.Create(nameof(Axis), typeof(RotationAxis), typeof(RotateAction), RotationAxis.Z);
